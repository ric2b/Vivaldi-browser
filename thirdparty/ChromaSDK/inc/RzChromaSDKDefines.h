...
static const GUID BLACKWIDOW_CHROMA = {
    ...
    0xca28,
    0x428d,
    {0x9f, 0x06, 0x19, 0x6b, 0x88, 0x33, 0x0b, 0xbb}};
...
static const GUID BLACKWIDOW_CHROMA_TE = {
    ...
    0xbfbe,
    0x418f,
    {0xb4, 0x9d, 0xd0, 0x3f, 0x5, 0xb1, 0x49, 0xdf}};
...
static const GUID DEATHSTALKER_CHROMA = {
    ...
    0x4326,
    0x4828,
    {0x92, 0xc4, 0x26, 0x69, 0xa6, 0x6d, 0x22, 0x83}};
...
static const GUID OVERWATCH_KEYBOARD = {
    ...
    0x7959,
    0x4478,
    {0x9f, 0xed, 0x15, 0xf6, 0x18, 0x6e, 0x72, 0xe4}};
...
static const GUID BLACKWIDOW_X_CHROMA = {
    ...
    0xade9,
    0x43d4,
    {0xb5, 0x74, 0x52, 0x59, 0x92, 0x93, 0xb5, 0x54}};
...
static const GUID BLACKWIDOW_X_TE_CHROMA = {
    ...
    0x3290,
    0x4aac,
    {0x9a, 0x89, 0xd8, 0xaf, 0xde, 0x38, 0xb5, 0x7c}};
...
static const GUID OMATA_CHROMA = {
    ...
    0xcc48,
    0x4970,
    {0x85, 0x39, 0xd8, 0x28, 0xcc, 0x1d, 0x42, 0xa}};
...
static const GUID BLADE_STEALTH = {
    ...
    0xe7fc,
    0x40e0,
    {0x99, 0xdb, 0x87, 0x2e, 0x23, 0xf1, 0x98, 0x91}};

//! Razer Blade
// {F2BEDFAF-A0FE-4651-9D41-B6CE603A3DDD}
static const GUID BLADE = {0xf2bedfaf,
                           0xa0fe,
                           0x4651,
                           {0x9d, 0x41, 0xb6, 0xce, 0x60, 0x3a, 0x3d, 0xdd}};
...
static const GUID BLADE_PRO = {
    ...
    0xf0e5,
    0x4bf7,
    {0x91, 0xae, 0xdd, 0x1f, 0x7e, 0x17, 0x37, 0xa5}};
...
static const GUID BLACKWIDOW_CHROMA2 = {
    ...
    0xb402,
    0x44bd,
    {0xa7, 0xa6, 0x7a, 0xa9, 0xf5, 0x74, 0xec, 0xf4}};
...
static const GUID DEATHADDER_CHROMA = {
    ...
    0xb1f1,
    0x452f,
    {0x8e, 0x16, 0x7b, 0x73, 0xf3, 0x76, 0xfd, 0xf3}};
...
static const GUID MAMBA_CHROMA_TE = {
    ...
    0xe0ee,
    0x4289,
    {0x89, 0xd5, 0xd, 0x87, 0x9c, 0x19, 0x6, 0x1a}};
...
static const GUID DIAMONDBACK_CHROMA = {
    ...
    0x4512,
    0x4257,
    {0x8d, 0x59, 0xc6, 0x47, 0xbf, 0x99, 0x35, 0xd0}};
...
static const GUID MAMBA_CHROMA = {
    ...
    0xeb0a,
    0x483a,
    {0x9e, 0x89, 0x66, 0xd5, 0x4, 0x63, 0xec, 0x6c}};
...
static const GUID NAGA_EPIC_CHROMA = {
    ...
    0x7158,
    0x4368,
    {0xb9, 0x9c, 0x60, 0x1a, 0xcb, 0x98, 0x5e, 0x98}};
...
static const GUID NAGA_CHROMA = {
    ...
    0x6ca4,
    0x46ae,
    {0xbe, 0x4, 0xbe, 0x81, 0x2b, 0x41, 0x44, 0x33}};
...
static const GUID OROCHI_CHROMA = {
    ...
    0x4ece,
    0x4dd9,
    {0x8a, 0x52, 0xa1, 0x41, 0x84, 0x59, 0xeb, 0x34}};
...
static const GUID NAGA_HEX_CHROMA = {
    ...
    0xf285,
    0x4cff,
    {0x99, 0xf2, 0xb8, 0xc0, 0xe9, 0x65, 0x8d, 0xb4}};
...
static const GUID DEATHADDER_ELITE_CHROMA = {
    ...
    0x3237,
    0x4a9f,
    {0xad, 0x77, 0x4a, 0x46, 0xc4, 0x18, 0x30, 0x3}};
...
static const GUID KRAKEN71_CHROMA = {
    ...
    0xd5e6,
    0x4a6c,
    {0xa9, 0x3b, 0xe6, 0xd9, 0xbf, 0x1d, 0x20, 0x92}};
...
static const GUID MANOWAR_CHROMA = {
    ...
    0x5408,
    0x4a0e,
    {0x8a, 0x7f, 0xa7, 0x41, 0x2f, 0x26, 0xbe, 0xbf}};
...
static const GUID KRAKEN71_REFRESH_CHROMA = {
    ...
    0x9e74,
    0x4bb3,
    {0x8c, 0x86, 0xca, 0xc7, 0xf7, 0x89, 0x1e, 0xbd}};
...
static const GUID FIREFLY_CHROMA = {
    ...
    0x73d2,
    0x48ca,
    {0xae, 0x9a, 0x9, 0x86, 0x78, 0x9a, 0x9a, 0xf2}};
...
static const GUID TARTARUS_CHROMA = {
    ...
    0xe180,
    0x4ad1,
    {0x8e, 0x8a, 0x41, 0x90, 0x61, 0xce, 0x50, 0x5e}};
...
static const GUID ORBWEAVER_CHROMA = {
    ...
    0x162,
    0x466c,
    {0x96, 0x40, 0x7a, 0x92, 0x4a, 0xa4, 0xd9, 0xfd}};
...
static const GUID LENOVO_Y900 = {
    ...
    0x1ae5,
    0x436c,
    {0xa5, 0x75, 0xab, 0x44, 0xa1, 0x27, 0x90, 0x3a}};
...
static const GUID LENOVO_Y27 = {
    ...
    0x6b9b,
    0x4ee6,
    {0xb6, 0xf4, 0x40, 0x71, 0xa3, 0xb2, 0x5, 0x3b}};
...
static const GUID CORE_CHROMA = {
    ...
    0x62f3,
    0x4c50,
    {0x83, 0xdd, 0x59, 0x8b, 0xab, 0xd2, 0x8, 0xe0}};

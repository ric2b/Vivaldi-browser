...
- (void)installWithToolAndRelaunch:(BOOL)relaunch displayingUserInterface:(BOOL)showUI
{
    ...
    //NOTE(tomas@vivaldi.com) Vivaldi has moved the Autoupdate.app inside the bundle to be able to sign and notarize our app.
    NSString *const relaunchToolSourcePath = [sparkleBundle pathForResource:relaunchToolSourceName ofType:@"app" inDirectory:@"Helpers"];

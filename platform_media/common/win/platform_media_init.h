...
#ifndef PLATFORM_MEDIA_COMMON_WIN_PLATFORM_MEDIA_INIT_H_
#define PLATFORM_MEDIA_COMMON_WIN_PLATFORM_MEDIA_INIT_H_
...
// functions here can be used during early process initialization to pre-load
// various libraries during sandbox initialization without adding dependency on
// the media.
...
BASE_EXPORT void OnFFmpegInit();

}  // namespace platform_media_init

#endif  // PLATFORM_MEDIA_COMMON_WIN_PLATFORM_MEDIA_INIT_H_

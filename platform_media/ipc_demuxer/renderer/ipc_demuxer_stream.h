...
#ifndef PLATFORM_MEDIA_IPC_DEMUXER_RENDERER_IPC_DEMUXER_STREAM_H_
#define PLATFORM_MEDIA_IPC_DEMUXER_RENDERER_IPC_DEMUXER_STREAM_H_
...
#endif  // PLATFORM_MEDIA_IPC_DEMUXER_RENDERER_IPC_DEMUXER_STREAM_H_

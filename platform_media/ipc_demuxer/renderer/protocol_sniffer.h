...
#ifndef PLATFORM_MEDIA_IPC_DEMUXER_RENDERER_PROTOCOL_SNIFFER_H_
#define PLATFORM_MEDIA_IPC_DEMUXER_RENDERER_PROTOCOL_SNIFFER_H_
...
#endif  // PLATFORM_MEDIA_IPC_DEMUXER_RENDERER_PROTOCOL_SNIFFER_H_

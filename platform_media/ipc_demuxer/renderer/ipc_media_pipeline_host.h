...
#ifndef PLATFORM_MEDIA_IPC_DEMUXER_RENDERER_IPC_MEDIA_PIPELINE_HOST_H_
#define PLATFORM_MEDIA_IPC_DEMUXER_RENDERER_IPC_MEDIA_PIPELINE_HOST_H_
...
#endif  // PLATFORM_MEDIA_IPC_DEMUXER_RENDERER_IPC_MEDIA_PIPELINE_HOST_H_

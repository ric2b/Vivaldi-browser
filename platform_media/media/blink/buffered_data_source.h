...
class BufferedDataSourceInterface : public DataSource {
 public:
  ...
  virtual void SetPreload(MultibufferDataSource::Preload preload) = 0;

  // Adjusts the buffering algorithm based on the given buffering strategy
  // value.
  virtual void SetBufferingStrategy(MultibufferDataSource::BufferingStrategy buffering_strategy) = 0;
...
class MEDIA_BLINK_EXPORT BufferedDataSource
 ...
 public:
  ...
  // Adjusts the buffering algorithm based on the given preload value.
  void SetPreload(MultibufferDataSource::Preload preload) override;

  // Adjusts the buffering algorithm based on the given buffering strategy
  // value.
  void SetBufferingStrategy(MultibufferDataSource::BufferingStrategy buffering_strategy) override;

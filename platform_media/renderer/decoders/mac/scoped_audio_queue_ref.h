...
#ifndef PLATFORM_MEDIA_RENDERER_DECODERS_MAC_SCOPED_AUDIO_QUEUE_REF_H_
#define PLATFORM_MEDIA_RENDERER_DECODERS_MAC_SCOPED_AUDIO_QUEUE_REF_H_
...
#endif  // PLATFORM_MEDIA_RENDERER_DECODERS_MAC_SCOPED_AUDIO_QUEUE_REF_H_

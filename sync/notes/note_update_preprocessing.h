...
// preprocess remote note updates, to deal with backward-compatibility of
// data and migrate updates such that they resemble updates from a modern
// client.

#ifndef SYNC_NOTES_NOTE_UPDATE_PREPROCESSING_H_
#define SYNC_NOTES_NOTE_UPDATE_PREPROCESSING_H_
...
#endif  // SYNC_NOTES_NOTE_UPDATE_PREPROCESSING_H_

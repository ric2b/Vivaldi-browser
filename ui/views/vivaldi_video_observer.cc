...
VideoProgressObserver::VideoProgressObserver(
  vivaldi::VideoProgress* progress,
  content::WebContents* web_contents)
  : content::WebContentsObserver(web_contents), progress_(progress) {
...
void VideoProgressObserver::MediaSessionPositionChanged(
  ...
  if (progress_) {
    progress_->UpdateProgress(position_.value());
  }
}

bool VideoProgressObserver::SupportsAction(
    MediaSessionAction action) const {
  return actions_.contains(action);
}

void VideoProgressObserver::MediaSessionActionsChanged(
...
void VideoProgressObserver::WebContentsDestroyed() {
  progress_ = nullptr;
}

void VideoProgressObserver::SeekTo(double current_position,
...
void VideoProgressObserver::Seek(int seconds) {

...
public class UseNetworkAnnotations
    ...
    private static final ArrayList<String> ALLOWLISTED_FILES = new ArrayList<>(
            List.of("chromium/net/android/java/src/org/chromium/net/ChromiumNetworkAdapter.java",
                    ...
                    "android/java/src/org/vivaldi/browser/sync/VivaldiSyncHttpClient.java"));
    ...
    public Description matchMethodInvocation(MethodInvocationTree tree, VisitorState state) {
        ...
        /*!! TODO(jarle): find another solution
        ...
        while (srcDir != null && (!Files.isDirectory(srcDir.resolve(ERRORPRONE_PLUGIN_PATH)) || srcDir.endsWith("vivaldi"))) {

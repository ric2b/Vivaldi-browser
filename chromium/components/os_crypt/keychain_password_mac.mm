...
KeychainPassword::KeychainNameType KeychainPassword::service_name("Vivaldi Safe Storage");
KeychainPassword::KeychainNameType KeychainPassword::account_name("Vivaldi");
#else

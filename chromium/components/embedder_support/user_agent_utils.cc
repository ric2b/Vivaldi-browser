...
blink::UserAgentBrandList GenerateBrandVersionList(
  ...
  if (brand) {
    ...
    // VB-83905: "Not A Brand" need to be last in the header, especially when the semi-colon is at the front
    greased_brand_version_list[1] = greasey_bv;
    greased_brand_version_list[0] = chromium_bv;

...
TEST(AutofillCountryTest, MAYBE_LOCALE(AutofillCountry)) {
...
TEST(AutofillCountryTest, MAYBE_LOCALE(CountryCodeForLocale)) {
...
TEST(AutofillCountryTest, MAYBE_LOCALE(GetCountryCode)) {
  // Basic mapping

...
enum SearchEngineType {
  ...
  SEARCH_ENGINE_BING_VIV,
  SEARCH_ENGINE_YAHOO_VIV,
  SEARCH_ENGINE_STARTPAGE_COM_VIV,
  SEARCH_ENGINE_DUCKDUCKGO_VIV,
  SEARCH_ENGINE_ECOSIA_VIV,
  SEARCH_ENGINE_WIKIPEDIA_VIV,
  SEARCH_ENGINE_GOOGLE_VIV,

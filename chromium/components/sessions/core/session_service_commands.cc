...
static const SessionCommand::id_type kCommandCreateThumbnail = 202;
// VIVALDI SPECIFIC above
...
// Vivaldi code. Included here because of declarations above, and used below
...
// Vivaldi functions. Has to be after CreateTabsAndWindows().
#include "components/sessions/vivaldi_session_service_methods.inc"

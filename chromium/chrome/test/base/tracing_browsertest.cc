...
#define MAYBE_BeginTracingWithWatch DISABLED_BeginTracingWithWatch
#else
#define MAYBE_BeginTracingWithWatch BeginTracingWithWatch
#endif
IN_PROC_BROWSER_TEST_F(TracingBrowserTest, MAYBE_BeginTracingWithWatch) {

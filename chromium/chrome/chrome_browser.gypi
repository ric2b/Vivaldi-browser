...

{
  'variables': {
    ...
    'chrome_browser_non_ios_sources': [
      ...
      'browser/android/bookmark/edit_bookmark_helper.cc',
      'browser/android/bookmark/edit_bookmark_helper.h',
      ...
      'browser/mac/sparkle_util.h',
      'browser/mac/sparkle_util.mm',
        ...
        ['OS=="mac"', {
          ...
          'link_settings': {
            'libraries': [
              ...
              '-F<(VIVALDI)/third_party/Sparkle-1.9.0',
              'Sparkle.framework',

...
IN_PROC_BROWSER_TEST_F(GeolocationBrowserTest, DISABLED_Geoposition) {
  ASSERT_TRUE(Initialize(INITIALIZATION_NONE));
  SetFrameHost("");
  ASSERT_TRUE(RequestAndAcceptPermission());
...
// TODO reenable test for Vivaldi
IN_PROC_BROWSER_TEST_F(GeolocationBrowserTest, DISABLED_NoPromptForAllowedOrigin) {
  ASSERT_TRUE(Initialize(INITIALIZATION_NONE));
  current_browser()->profile()->GetHostContentSettingsMap()->SetContentSetting(
      ContentSettingsPattern::FromURLNoWildcard(current_url()),
      ContentSettingsPattern::FromURLNoWildcard(current_url()),
...
// TODO reenable test for Vivaldi
IN_PROC_BROWSER_TEST_F(GeolocationBrowserTest, DISABLED_NoPromptForOffTheRecord) {
...
// TODO reenable test for Vivaldi
IN_PROC_BROWSER_TEST_F(GeolocationBrowserTest, DISABLED_NoLeakFromOffTheRecord) {
...
// TODO reenable test for Vivaldi
IN_PROC_BROWSER_TEST_F(GeolocationBrowserTest, DISABLED_IFramesWithFreshPosition) {
...
// TODO reenable test for Vivaldi
IN_PROC_BROWSER_TEST_F(GeolocationBrowserTest, DISABLED_CancelPermissionForFrame) {
  set_html_for_tests("/geolocation/two_iframes.html");
  ASSERT_TRUE(Initialize(INITIALIZATION_IFRAMES));
  LoadIFrames(2);
...
// TODO reenable test for Vivaldi
IN_PROC_BROWSER_TEST_F(GeolocationBrowserTest, DISABLED_NoPromptBeforeStart) {
...
// TODO reenable test for Vivaldi
IN_PROC_BROWSER_TEST_F(GeolocationBrowserTest, DISABLED_TwoWatchesInOneFrame) {

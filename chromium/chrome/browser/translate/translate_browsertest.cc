...
#define MAYBE_TranslateInIsolatedWorld DISABLED_TranslateInIsolatedWorld
#else
#define MAYBE_TranslateInIsolatedWorld TranslateInIsolatedWorld
#endif
IN_PROC_BROWSER_TEST_F(TranslateBrowserTest, MAYBE_TranslateInIsolatedWorld) {

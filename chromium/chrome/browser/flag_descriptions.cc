...
// Vivaldi
const char kAndroidNewStartPageName[] = "Android New Start Page";
const char kAndroidNewStartPageDescription[] =
    "New start page with easy customization and new Speed Dial dialogs";
// End Vivaldi

...
IN_PROC_BROWSER_TEST_F(AppViewTest, DISABLED_TestAppViewWithUndefinedDataShouldSucceed) {
...
// tomas@vivaldi.com - disabled test (VB-7468)
IN_PROC_BROWSER_TEST_F(AppViewTest, DISABLED_TestAppViewEmbedSelfShouldFail) {
  const extensions::Extension* skeleton_app =
      InstallPlatformApp("app_view/shim/skeleton");

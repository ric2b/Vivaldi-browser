...
// tomas@vivaldi.com disabled test (change from MAYBE_ to DISABLED_)
// VB-7266
IN_PROC_BROWSER_TEST_F(AppShimInteractiveTest, DISABLED_HostedAppLaunch) {
...
// VB-7266
IN_PROC_BROWSER_TEST_F(AppShimInteractiveTest, DISABLED_RebuildShim) {
  // Get the 32 bit shim.

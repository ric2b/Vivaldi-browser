...
public abstract class ChromeFeatureList {
    ...
    // Vivaldi
    public static final String ANDROID_NEW_STARTPAGE = "AndroidNewStartPage";
    // End Vivaldi
    ...
    public static final CachedFlag sAndroidHub = newCachedFlag(ANDROID_HUB, false); // Vivaldi
    ...
    public static final CachedFlag sDynamicTopChrome = newCachedFlag(DYNAMIC_TOP_CHROME, false); // Vivaldi
    ...
    public static final CachedFlag sSurfacePolish = newCachedFlag(SURFACE_POLISH, false); // Vivaldi Ref. VAB-9134
    ...
    // Vivaldi
    public static final MutableFlagWithSafeDefault sAndroidNewStartPage =
            newMutableFlagWithSafeDefault(ANDROID_NEW_STARTPAGE, false);
    // End Vivaldi

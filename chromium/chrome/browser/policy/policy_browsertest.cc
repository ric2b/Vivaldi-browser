...
const content::WebPluginInfo* GetFlashPlugin(
  ...
  // Vivaldi does not ship with Flash yet
...
//tomas@vivaldi.com: disabled browser_tests for linux (VB-7468)
IN_PROC_BROWSER_TEST_F(PolicyTest, DISABLED_FullscreenAllowedApp) {
  PolicyMap policies;
  policies.Set(key::kFullscreenAllowed,
               POLICY_LEVEL_MANDATORY,
               POLICY_SCOPE_USER,

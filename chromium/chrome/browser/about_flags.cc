...
// Vivaldi
    {"android-new-startpage",
      flag_descriptions::kAndroidNewStartPageName,
      flag_descriptions::kAndroidNewStartPageDescription, kOsAndroid,
      FEATURE_VALUE_TYPE(chrome::android::kAndroidNewStartPage)},
// End vivaldi
#endif  // BUILDFLAG(IS_ANDROID)

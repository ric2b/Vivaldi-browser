...
#define MAYBE_RecentTabsMenuTabDisposition DISABLED_RecentTabsMenuTabDisposition
#else
#define MAYBE_RecentTabsMenuTabDisposition RecentTabsMenuTabDisposition
#endif
IN_PROC_BROWSER_TEST_F(BrowserTabRestoreTest, MAYBE_RecentTabsMenuTabDisposition) {
  // Create tabs.
...
// TODO: Re-enable for Vivaldi
#if defined(OS_MACOSX)
#define MAYBE_DelegateRestoreTabDisposition DISABLED_DelegateRestoreTabDisposition
#else
#define MAYBE_DelegateRestoreTabDisposition DelegateRestoreTabDisposition
#endif
IN_PROC_BROWSER_TEST_F(BrowserTabRestoreTest, MAYBE_DelegateRestoreTabDisposition) {
  // Create tabs.
  CreateTestTabs(browser());
  EXPECT_EQ(3, browser()->tab_strip_model()->count());

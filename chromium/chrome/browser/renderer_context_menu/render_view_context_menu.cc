...
#ifdef VIVALDI_BUILD
    // We avoid several patches fixing DefaultSearchProviderIsGoogle to check
    // the image search instead by just disabling the Google Lens entry, which
    // used to not be available anyway.
    {
#else

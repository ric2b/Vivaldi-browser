...
#include "chrome/browser/extensions/api/thumbnails/thumbnails_api.h"
...
bool ThumbnailsIsThumbnailAvailableFunction::RunAsync() {
  scoped_ptr<api::thumbnails::IsThumbnailAvailable::Params> params(
      api::thumbnails::IsThumbnailAvailable::Params::Create(*args_));
  ...
  api::thumbnails::ThumbnailQueryResult result;
  result.has_thumbnail = has_thumbnail;
  result.thumbnail_url = url.spec();

  results_ = api::thumbnails::IsThumbnailAvailable::Results::Create(result);

...
#ifndef CHROME_BROWSER_EXTENSIONS_API_EXTENSION_ACTION_EXTENSION_ACTION_UTILS_API_H_
#define CHROME_BROWSER_EXTENSIONS_API_EXTENSION_ACTION_EXTENSION_ACTION_UTILS_API_H_
...
#include "chrome/common/extensions/api/browser_action_utilities.h"
...
class ExtensionActionUtilFactory : public BrowserContextKeyedServiceFactory {
 ...
 private:
  friend struct DefaultSingletonTraits<ExtensionActionUtilFactory>;
...
class ExtensionActionUtil : public KeyedService,
  ...
  friend struct DefaultSingletonTraits<ExtensionActionUtil>;
  Profile* profile_;
...
#endif  // CHROME_BROWSER_EXTENSIONS_API_EXTENSION_ACTION_EXTENSION_ACTION_UTILS_API_H_

...
//tomas@vivaldi.com: disabled unit_tests (VB-8737)
TEST_F(SessionStartupPrefTest, DISABLED_DefaultMigration) {
...
//tomas@vivaldi.com: disabled unit_tests (VB-8737)
TEST_F(SessionStartupPrefTest, DISABLED_DefaultMigrationHomepageIsNTP) {
  registry()->RegisterStringPref(prefs::kHomePage, "http://google.com/");
  pref_service_->SetString(prefs::kHomePage, "http://chromium.org/");

...
struct SessionStartupPref {
  ...
  static const int kPrefValueVivaldiSpeeddial = 6;
  static const int kPrefValueVivaldiHomepage = 7;
  static const int kPrefValueVivaldiSpecificSession = 8;
  static const int kPrefValueMax = 9;

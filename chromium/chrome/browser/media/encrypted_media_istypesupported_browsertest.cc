...
#define EXPECT_WVMP4 EXPECT_PROPRIETARY
#define EXPECT_WVAAC EXPECT_PROPRIETARY
#define EXPECT_WVAVC1 EXPECT_PROPRIETARY
#define EXPECT_WVAVC1AAC EXPECT_PROPRIETARY

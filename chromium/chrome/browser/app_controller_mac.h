...
#import "vivaldi/Sparkle/SPUStandardUpdaterController.h"
#endif
...
#ifndef VIVALDI_SPARKLE_DISABLED
@property(readonly, nonatomic) SparkleUpdaterDelegate* sparkle_updater_delegate;
@property(readonly, nonatomic) SPUStandardUpdaterController* sparkle_updater_controller;
#endif

...
#define MAYBE_MimeTypesToShowNotDownload DISABLED_MimeTypesToShowNotDownload
#else
#define MAYBE_MimeTypesToShowNotDownload MimeTypesToShowNotDownload
#endif
IN_PROC_BROWSER_TEST_F(DownloadTest, MAYBE_MimeTypesToShowNotDownload) {

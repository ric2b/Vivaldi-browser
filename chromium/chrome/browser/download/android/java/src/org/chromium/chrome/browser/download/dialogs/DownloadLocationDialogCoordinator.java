...
public class DownloadLocationDialogCoordinator implements ModalDialogProperties.Controller {
    ...
    private void onDirectoryOptionsRetrieved(ArrayList<DirectoryOption> dirs) {
        ...
        // Vivaldi
        // NOTE(simonb@vivaldi.com): We want users to be able to see prompts dialog before
        // downloading anything, unless they turn prompts off. This check skips the Chrome standard
        // solution of instantly downloading and opening files.

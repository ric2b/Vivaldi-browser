    ...
    ['OS=="linux" and (branding == "Chrome" or branding=="vivaldi")', {
      'variables': {
        ...
        'packaging_files_common': [
          ...
          'installer/linux/common/xfce-helper.template',
          'installer/linux/common/vivaldi/vivaldi.info',
        ...
        'packaging_files_rpm': [
          ...
          'installer/linux/rpm/vivaldi.spec.template',
      ...
      'targets': [
        {
          ...
          # "hermetic" for packaging. This is only for branding="vivaldi" since
          ...
          'actions': [
            {
              ...
              'outputs': [
                '<(PRODUCT_DIR)/vivaldi-<(channel)_<(version)-1_<(deb_arch).deb',
              ],
          ...
          'actions': [
            {
              ...
              'inputs': [
                '<(rpm_build)',
                '<(PRODUCT_DIR)/installer/rpm/vivaldi.spec.template',
                '<@(packaging_files_binaries)',
                '<@(packaging_files_common)',
                '<@(packaging_files_rpm)',
              ],
              'outputs': [
                '<(PRODUCT_DIR)/vivaldi-<(channel)-<(version)-1.<(rpm_arch).rpm',
              ],
      ...
      'targets': [
        {
          ...
          'conditions': [
            ['buildtype=="Official" or branding=="vivaldi"', {
              'actions': [
                {

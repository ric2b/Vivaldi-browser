...
public class MainSettings extends ChromeBaseSettingsFragment
    ...
    private void createPreferences() {
        ...
        if (ChromeApplicationImpl.isVivaldi()) {
            ...
            PreferenceSearchManager.getInstance().initialize(getActivity());
        } else
            ...
            if (BuildConfig.IS_OEM_AUTOMOTIVE_BUILD) {
                if (VivaldiUtils.driverDistractionHandlingEnabled()) {
                    ...
                    PreferenceSearchManager.getInstance()
                            .excludePreference(PREF_ALLOW_BACKGROUND_MEDIA);
                }
                if (!VivaldiUtils.isVivaldiScreenLockEnabled()) {
                    PreferenceSearchManager.getInstance()
                            .excludePreference(VivaldiPreferences.SCREEN_LOCK);
                }
            }
        }

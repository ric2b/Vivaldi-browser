...
class BookmarkToolbarViewBinder {
    ...
    public static void bind(PropertyModel model, BookmarkToolbar bookmarkToolbar, PropertyKey key) {
        ...
        } else if (key == BookmarkToolbarProperties.CLOSE_BUTTON_VISIBLE) {
            bookmarkToolbar.setCloseButtonVisible(
                    model.get(BookmarkToolbarProperties.CLOSE_BUTTON_VISIBLE));

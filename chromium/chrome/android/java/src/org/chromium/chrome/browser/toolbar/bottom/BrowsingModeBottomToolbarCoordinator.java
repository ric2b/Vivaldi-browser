...
public class BrowsingModeBottomToolbarCoordinator {
    ...
    private final NavigationButton mBackButton;
    private final NavigationButton mForwardButton;
    ...
    BrowsingModeBottomToolbarCoordinator(View root, ActivityTabProvider tabProvider,
        ...
        if (ChromeApplication.isVivaldi()) {
            mHomeButton = mToolbarRoot.findViewById(R.id.vivaldi_home_button);
        } else {
        ...
        mSearchAccelerator = mToolbarRoot.findViewById(R.id.vivaldi_search_accelerator);
        ...
        mBackButton = mToolbarRoot.findViewById(R.id.back_button);
        mBackButton.setOnClickListener((View v) -> activity.getToolbarManager().back());
        mBackButton.setActivityTabProvider(mTabProvider);
        mBackButton.setNavigationType(NavigationButton.NavigationType.NAV_BACK);

        mForwardButton = mToolbarRoot.findViewById(R.id.forward_button);
        mForwardButton.setOnClickListener((View v) -> activity.getToolbarManager().forward());
        mForwardButton.setActivityTabProvider(mTabProvider);
        mForwardButton.setNavigationType(NavigationButton.NavigationType.NAV_FORWARD);

        mPanelButton = mToolbarRoot.findViewById(R.id.panel_button);

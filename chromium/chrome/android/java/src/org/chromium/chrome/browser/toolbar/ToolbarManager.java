...
public class ToolbarManager implements UrlFocusChangeListener, ThemeColorObserver, TintObserver,
    ...
    private OnClickListener mNewTabClickHandler;
    ...
    public ToolbarManager(AppCompatActivity activity, BrowserControlsSizer controlsSizer,
        ...
        mActivityTabTabObserver = new ActivityTabProvider.ActivityTabTabObserver(
            ...
            public void onObservingDifferentTab(Tab tab, boolean hint) {
                ...
                // Vivaldi
                toolbarLayout.updateShieldButtonState(tab.getUrl().getSpec());
            }
            ...
            public void onPageLoadFinished(Tab tab, GURL url) {
                ...
                // Note(david@vivaldi.com): Reset the url bar focus on a new tab in order to gain a
                // normal focus when user hits the url bar again.
                if (isUrlBarFocused())
    ...
    public void enableBottomControls() {
        ...
        mTabGroupUi = TabManagementModuleProvider.getDelegate().createTabGroupUi(mActivity,
                root.findViewById(R.id.tab_group_ui_toolbar_view), mIncognitoStateProvider,
        ...
        mTabGroupUi.setThemeColorProvider(tabGroupUiThemeProvider);
        ...
        if (ChromeApplicationImpl.isVivaldi()) {
            ...
            mBottomToolbarCoordinator.postInit(mTabSwitcherClickHandler, mNewTabClickHandler,
                    mTabCountProvider, mIncognitoStateProvider,
                    mActivity.findViewById(R.id.control_container));
            // Note(david@vivaldi.com) We need to update the |TopUiThemeColorProvider| in order to
            // apply the correct theme after recreating the activity.
            mTopUiThemeColorProvider.forceUpdateColor(mTabModelSelector.getCurrentTab());
            updateButtonStatus();
        }
    }
    ...
    public void initializeWithNative(LayoutManagerImpl layoutManager,
        ...
        mNewTabClickHandler = newTabClickHandler;
    ...
    private void updateButtonStatus() {
        ...
        if (!toolbarNavButtonsVisible && mBottomToolbarCoordinator != null) {
            ...
            if (currentTab != null) {
                ...
                boolean showSearch = nativePage != null
                        && (nativePage instanceof SpeedDialPage
        ...
        // Vivaldi
        View toolbarLayout = mActivity.findViewById(R.id.toolbar);
        if (toolbarLayout instanceof ToolbarLayout) {
            ((ToolbarLayout) toolbarLayout).updateShieldButtonState(
    ...
    /** Vivaldi
     * @return The overlay visibility supplier.
     */
    public ObservableSupplierImpl<Boolean> getOverlayVisibilitySupplier() {
        return mOverlayPanelVisibilitySupplier;
    }

    /** Vivaldi
     * @return The coordinator for the menu button if it exists.
     */
    public MenuButtonCoordinator getMenuButtonCoordinator() {

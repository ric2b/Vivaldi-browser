...
public class WebappLauncherActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (webappId != null && webappUrl != null) {
            ...
            if (webappMac != null && WebappAuthenticator.isUrlValid(this, webappUrl, webappMac)) {
                ...
                launchIntent = createWebappIntent(webappId, webappUrl, webappIcon, webappTitle,
                        webappOrientation, webappSource);
            } else {
     ...
     * @param title       String representing the webapp.
     ...
     */
    private Intent createWebappIntent(String id, String url, String icon, String title,

...
public class BookmarkUtils {
    ...
    public static void addOrEditBookmark(
        ...
        if (ChromeApplicationImpl.isVivaldi()) {
            BookmarkId newBookmarkId = addBookmarkInternal(activity,
                    tab.getProfile(),
    ...
    static BookmarkId addBookmarkInternal(
        ...
        if (bookmarkType == BookmarkType.READING_LIST
            ...
            bookmarkId = bookmarkModel.addToReadingList(bookmarkModel.getLocalOrSyncableReadingListFolder(), title, url);
        } else {

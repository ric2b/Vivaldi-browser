...
/* Vivaldi */ public class AutocompleteMediator implements OnSuggestionsReceivedListener, StartStopWithNativeObserver,
    ...
    @NonNull
    /* Vivaldi */ public AutocompleteResult mAutocompleteResult = AutocompleteResult.EMPTY_RESULT;
    @Nullable
    ...
    void startCachedZeroSuggest() {
        ...
        if (mNativeInitialized || VivaldiUtils.showSearchEngineSuggestionBar()) return;

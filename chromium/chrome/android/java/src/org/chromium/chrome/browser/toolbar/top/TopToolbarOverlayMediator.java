...
public class TopToolbarOverlayMediator {
    ...
    TopToolbarOverlayMediator(PropertyModel model, Context context,
        ...
        mBrowserControlsObserver = new BrowserControlsStateProvider.Observer() {
            ...
            public void onControlsOffsetChanged(int topOffset, int topControlsMinHeightOffset,
                ...
                // Note(david@vivaldi.com): Apply top control offset when toolbar is at the top.
    ...
    private void updateVisibility() {
        // Note(david@vivaldi.com): When toolbar is at the bottom the overlay is always invisible.
        if (!VivaldiUtils.isTopToolbarOn())

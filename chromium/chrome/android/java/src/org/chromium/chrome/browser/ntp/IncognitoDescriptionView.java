...
public class IncognitoDescriptionView extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        if (BuildConfig.IS_VIVALDI) { // Vivaldi Ref VAB-9323
            ...
            mSubtitle.setText(R.string.new_tab_private_message);
            mSubtitle.setGravity(Gravity.CENTER);
            ((ImageView) findViewById(R.id.new_tab_incognito_icon)).setImageTintList(null);
    ...
    private void adjustLayout() {
        ...
        if (mWidthDp <= WIDE_LAYOUT_THRESHOLD_DP) {
            ...
            if (BuildConfig.IS_VIVALDI) mContainer.setGravity // Vivaldi Ref VAB-9323

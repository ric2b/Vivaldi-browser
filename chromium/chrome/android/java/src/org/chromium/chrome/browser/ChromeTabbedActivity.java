...
public class ChromeTabbedActivity extends ChromeActivity<ChromeActivityComponent>
    ...
    private final static String WELCOME_PAGE_URL = "https://vivaldi.com/android/new/";
    ...
    public void finishNativeInitialization() {
        ...
        if (ChromeApplication.isVivaldi() && SharedPreferencesManager.getInstance()
                .readBoolean(VivaldiPreferences.SHOW_WELCOME_PAGE, false)) {
            SharedPreferencesManager.getInstance().writeBoolean(
                    VivaldiPreferences.SHOW_WELCOME_PAGE, false);
            createNewMajorVersionTab();
        }
    }
    ...
    public boolean onMenuOrKeyboardAction(final int id, boolean fromMenu) {
        ...
        boolean currentTabIsNtp =
                currentTab != null && UrlUtilities.isNTPUrl(currentTab.getUrl());
        ...
        // Vivaldi specific:
            ...
            PageActionsSheet ps = new PageActionsSheet(this);
            ps.init(getCurrentWebContents());
            ps.show();
            ...
            if (VivaldiUtils.isCloseTabsOnExitEnabled()) mTabModelSelectorImpl.clearState();
            ...
            if (dataTypes != null) {
                ...
                BrowsingDataBridge.getInstance().clearBrowsingData(
                        () -> exitApplication(), dataTypes, TimePeriod.ALL_TIME);
            } else
                exitApplication();
        } else {
    ...
    public boolean handleBackPressed() {
        ...
        if (minimizeApp) {
            ...
            if (!mDoubleBackPressed && VivaldiUtils.isDoubleTapToExitEnabled()) {
    ...
    private void createNewMajorVersionTab() {
        if (!WELCOME_PAGE_URL.isEmpty())
            getTabCreator(false).launchUrl(WELCOME_PAGE_URL, TabLaunchType.FROM_STARTUP);
    }
}

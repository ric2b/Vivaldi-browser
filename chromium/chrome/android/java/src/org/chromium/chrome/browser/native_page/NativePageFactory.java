        ...
        protected NativePage buildSpeedDialPage(
            ...
            if (tab.isIncognito())
                return new IncognitoNewTabPage(mActivity,
                        new TabShim(tab, mBrowserControlsManager, mTabModelSelector),
                        tab.getProfile(), mEdgeToEdgeControllerSupplier);
            return new SpeedDialPage(mActivity,
                    new TabShim(tab, mBrowserControlsManager, mTabModelSelector), mTabModelSelector,
    ...
    private NativePage createNativePageForURLVivaldi(String url,
        ...
        switch (NativePage.nativePageType(url, candidatePage, isIncognito, false)) {
            ...
            case NativePageType.BOOKMARKS:
                ...
                break;
            case NativePageType.DOWNLOADS:
                // Vivaldi: For automotive, downloads are disabled. Show the generic downloads page
                // anyways. This is good for verifying that downloads do not happen.

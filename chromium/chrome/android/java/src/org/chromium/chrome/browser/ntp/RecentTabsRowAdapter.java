...
public class RecentTabsRowAdapter extends BaseExpandableListAdapter {
                    ...
                    public void onFaviconAvailable(Bitmap bitmap, GURL iconUrl) {
                        ...
                        Drawable faviconDrawable =
                                FaviconUtils.getIconDrawableWithFilter(bitmap, url, mIconGenerator,
                                        mDefaultFaviconHelper, mActivity, mFaviconSize);
    ...
    public void notifyDataSetChanged() {
        mGroups.clear();
        // NOTE(david@vivaldi.com): The RecentlyClosedTabsGroup will be only added when we are
        // showing the recently closed tab page of the tab switcher.
        ...
        // NOTE(david@vivaldi.com): When we have a VivaldiRecentTabsManager, then this list is
        // integrated into the tab switcher view and we are returning here.
        if (mRecentTabsManager.getVivaldiRecentTabsManager() != null) {

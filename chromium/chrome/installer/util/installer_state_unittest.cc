...
TEST_F(InstallerStateTest, Delete) {
  ...
  chrome_dll_1 = chrome_dll_1.AppendASCII("vivaldi.dll");
  ...
  chrome_dll_2 = chrome_dll_2.AppendASCII("vivaldi.dll");
  ...
  chrome_dll_3 = chrome_dll_3.AppendASCII("vivaldi.dll");
  ...
  chrome_dll_4 = chrome_dll_4.AppendASCII("vivaldi.dll");

...
const wchar_t kGoogleUpdateSetupExe[] = L"VivaldiUpdateSetup.exe";

const wchar_t kRegPathClients[] = L"Software\\Vivaldi\\Update\\Clients";
const wchar_t kRegPathClientState[] = L"Software\\Vivaldi\\Update\\ClientState";
const wchar_t kRegPathClientStateMedium[] =
    L"Software\\Vivaldi\\Update\\ClientStateMedium";
const wchar_t kRegPathGoogleUpdate[] = L"Software\\Vivaldi\\Update";

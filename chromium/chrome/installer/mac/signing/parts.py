    ...
    parts = {
        'app':
            CodeSignedProduct(
                ...
                options=app_hardened_runtime_options,
        ...
        'mac-sparkle-framework':
            CodeSignedProduct(
                "{.app_dir}/Contents/Frameworks/Sparkle.framework".format(config),
...
def sign_chrome(paths, config, sign_framework=False):
    ...
    if sign_framework:
        ...
        for name, part in parts.items():
            if name in ('app', 'framework', 'privileged-helper', "mac-sparkle-framework", "mac-sparkle-updater-app"):
                continue

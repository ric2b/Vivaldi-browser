...
# found in the LICENSE file.
{
  'variables': {
    ...
    'chrome_unit_tests_extensions_sources': [
      ...
      #'common/extensions/api/extension_api_unittest.cc', # moved to unit_tests_sub
  ...
  'targets': [
	...
	{
      'target_name': 'unit_tests_sub',
      # includes object files that have names identical to the ones in unit_tests
      'type': 'static_library',
      'dependencies': [

    ...
    'variables': {
      'variables': {
        ...
        'conditions': [
          ...
          ['OS=="linux" and (((branding=="Chrome" or branding=="vivaldi") and buildtype=="Official" and chromeos==0) or use_sysroot==1)' , {
            'conditions': [
              ['target_arch=="x64"', {
    ...
    ['OS=="mac"', {
      'target_defaults': {
        ...
        'configurations': {
          'Release_Base': {
            'conditions': [
              ['(branding=="Chrome" or branding=="vivaldi") and buildtype=="Official"', {
                'xcode_settings': {
                  'OTHER_CFLAGS': [

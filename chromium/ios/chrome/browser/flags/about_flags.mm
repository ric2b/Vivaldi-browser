...
const flags_ui::FeatureEntry kFeatureEntries[] = {
  ...
  // Vivaldi
    {"vivaldi-new-start-page", flag_descriptions::kNewStartPageLayout,
     flag_descriptions::kNewStartPageLayoutDescription, flags_ui::kOsIos,
     FEATURE_VALUE_TYPE(kNewStartPage)},
  // End Vivaldi
};

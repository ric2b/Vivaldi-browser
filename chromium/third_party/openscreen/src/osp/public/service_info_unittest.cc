...
TEST(ServiceInfoTest, Compare) {
  ...
  const ServiceInfo receiver2{
      "id2", "name2", "fingerprint2", 1, {{192, 168, 1, 11}, 12346}, {}};
  const ServiceInfo receiver1_alt_id{
      "id3", "name1", "fingerprint1", 1, {{192, 168, 1, 10}, 12345}, {}};
  const ServiceInfo receiver1_alt_name{
      "id1", "name2", "fingerprint1", 1, {{192, 168, 1, 10}, 12345}, {}};
  const ServiceInfo receiver1_alt_fingerprint{
      "id1", "name1", "fingerprint2", 1, {{192, 168, 1, 10}, 12345}, {}};
  const ServiceInfo receiver1_alt_interface{
      "id1", "name1", "fingerprint1", 2, {{192, 168, 1, 10}, 12345}, {}};
  const ServiceInfo receiver1_alt_ip{
      "id3", "name1", "fingerprint1", 1, {{192, 168, 1, 12}, 12345}, {}};
  const ServiceInfo receiver1_alt_port{
      "id3", "name1", "fingerprint1", 1, {{192, 168, 1, 10}, 12645}, {}};
  ServiceInfo receiver1_ipv6{"id3", "name1", "fingerprint1", 1, {}, {}};
...
TEST(ServiceInfoTest, Update) {
  ServiceInfo original{
      "foo", "baz", "fingerprint1", 1, {{192, 168, 1, 10}, 12345}, {}};
  const ServiceInfo updated{
      "foo", "buzz", "fingerprint2", 1, {{193, 169, 2, 11}, 1234}, {}};
  original.Update("buzz", "fingerprint2", 1, {{193, 169, 2, 11}, 1234}, {});

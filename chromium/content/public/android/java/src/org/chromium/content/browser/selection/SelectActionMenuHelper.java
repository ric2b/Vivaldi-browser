...
public class SelectActionMenuHelper {
    ...
    static SelectionMenuGroup getDefaultItems(
        ...
        // Vivaldi
        defaultGroup.addItem(vivaldiTranslate(delegate.canShowVivaldiActionMenu()));
        defaultGroup.addItem(copyToNote(delegate.canShowVivaldiActionMenu()));
        defaultGroup.addItem(appendToNote(delegate.canShowVivaldiActionMenu()));
    ...
    // Vivaldi
    private static SelectionMenuItem vivaldiTranslate(boolean isEnabled) {
        return new SelectionMenuItem.Builder(R.string.translate)
                .setId(R.id.select_action_menu_translate)
                .setOrderInCategory(DefaultItemOrder.VIVALDI_TRANSLATE)
                .setShowAsActionFlags(
                        MenuItem.SHOW_AS_ACTION_ALWAYS | MenuItem.SHOW_AS_ACTION_WITH_TEXT)
                .setIsEnabled(isEnabled)
                .build();
    ...
    private static SelectionMenuItem copyToNote(boolean isEnabled) {
        return new SelectionMenuItem.Builder(R.string.vivaldi_copy_to_note)
                .setId(R.id.select_action_menu_copy_to_note)
                .setOrderInCategory(DefaultItemOrder.COPY_TO_NOTE)
                .setShowAsActionFlags(
                        MenuItem.SHOW_AS_ACTION_ALWAYS | MenuItem.SHOW_AS_ACTION_WITH_TEXT)
                .setIsEnabled(isEnabled)
                .build();

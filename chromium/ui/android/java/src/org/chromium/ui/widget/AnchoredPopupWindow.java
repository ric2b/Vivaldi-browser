...
public class AnchoredPopupWindow implements OnTouchListener, RectProvider.Observer {
    ...
    static PopupSpec calculatePopupWindowSpec(
        ...
        // NOTE(jarle@Vivaldi.com): Set the popup height to the available space above the anchor
        // to make sure we can show the tracker popup when the toolbar is at the bottom (VAB-5912).
        if (idealContentHeight > spaceAboveAnchor)
            idealContentHeight = spaceAboveAnchor;

...
//
const char kLibKeyName[]               = "Software\\Vivaldi\\Common\\Rlz";
const wchar_t kGoogleKeyName[]         = L"Software\\Vivaldi";
const wchar_t kGoogleCommonKeyName[]   = L"Software\\Vivaldi\\Common";

...
enum HistogramValue {
  ...
  SHOWMENU_CREATE,
  IMPORTDATA_GETPROFILES,
  IMPORTDATA_STARTIMPORT,
  ...
  IMPORTDATA_GETDEFAULTCONTENTSETTING,
  ...
  BOOKMARKS_UPDATESPEEDDIALSFORWINDOWSJUMPLIST,
  NOTES_GET,
  NOTES_GETCHILDREN,
  NOTES_GETTREE,
  NOTES_MOVE,
  ...
  WEBVIEWINTERNAL_GETWINDOWCOLOR,
  ...
  // Last Vivaldi entry: Add new entries above and ensure to update

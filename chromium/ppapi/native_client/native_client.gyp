        ...
        },
        {
          ...
          'variables': {
            ...
            'link_flags': [
              '-Wl,--start-group',
              '-lirt_browser',
              '-lcommon_chrome_constants_untrusted',
              '-llatency_info_nacl',
            ...
            'conditions': [
              ...
              ['target_arch=="ia32" or target_arch=="x64"', {
                'extra_deps_newlib64': [
                  '>(tc_lib_dir_irt64)/libcommon_chrome_constants_untrusted.a',
                ...
                'extra_deps_newlib32': [
                  '>(tc_lib_dir_irt32)/libcommon_chrome_constants_untrusted.a',
              ...
              ['target_arch=="arm"', {
                'extra_deps_arm': [
                  '>(tc_lib_dir_irt_arm)/libcommon_chrome_constants_untrusted.a',
          ...
          'dependencies': [
	        ...
	        '../../chrome/common_chrome_constants_untrusted.gyp:common_chrome_constants_untrusted',

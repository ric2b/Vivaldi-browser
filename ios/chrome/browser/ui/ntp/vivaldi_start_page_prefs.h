...
#ifndef IOS_CHROME_BROWSER_UI_NTP_VIVALDI_START_PAGE_PREFS_H_
#define IOS_CHROME_BROWSER_UI_NTP_VIVALDI_START_PAGE_PREFS_H_
...
#endif  // IOS_CHROME_BROWSER_UI_NTP_VIVALDI_START_PAGE_PREFS_H_

...
#ifndef IOS_CHROME_BROWSER_UI_VIVALDI_SPEED_DIAL_SHARED_STATE_H_
#define IOS_CHROME_BROWSER_UI_VIVALDI_SPEED_DIAL_SHARED_STATE_H_
...
#endif  // IOS_CHROME_BROWSER_UI_VIVALDI_SPEED_DIAL_SHARED_STATE_H_

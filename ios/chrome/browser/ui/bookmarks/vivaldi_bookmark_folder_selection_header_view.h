...
#ifndef IOS_CHROME_BROWSER_UI_BOOKMARK_FOLDER_SELECTION_HEADER_VIEW_H_
#define IOS_CHROME_BROWSER_UI_BOOKMARK_FOLDER_SELECTION_HEADER_VIEW_H_
...
#endif  // IOS_CHROME_BROWSER_UI_BOOKMARK_FOLDER_SELECTION_HEADER_VIEW_H_

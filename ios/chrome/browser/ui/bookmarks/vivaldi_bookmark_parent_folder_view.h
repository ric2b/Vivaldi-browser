...
#ifndef IOS_CHROME_BROWSER_UI_BOOKMARK_PARENT_FOLDER_VIEW_H_
#define IOS_CHROME_BROWSER_UI_BOOKMARK_PARENT_FOLDER_VIEW_H_
...
#endif  // IOS_CHROME_BROWSER_UI_BOOKMARK_PARENT_FOLDER_VIEW_H_

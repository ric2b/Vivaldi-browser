...
UIEdgeInsets textFieldPadding = UIEdgeInsetsMake(0.0, 12.0, 0.0, 0.0);
// Padding for the delete button
// In order - Top, Leading, Bottom, Trailing
UIEdgeInsets deleteTextButtonPadding = UIEdgeInsetsMake(0.0, 8.0, 0.0, 12.0);
// Padding for the underline view on the textfield
// In order - Top, Leading, Bottom, Trailing
UIEdgeInsets underlinePadding = UIEdgeInsetsMake(2.0, 12.0, 0.0, 0.0);
// Size for the underline
// In order - Width, Height
CGSize underlineSize = CGSizeMake(0.0, 0.5);
}

@interface VivaldiBookmarkTextFieldView()<UITextFieldDelegate>
...
@implementation VivaldiBookmarkTextFieldView
...
- (void)setUpUI {
  ...
  textField.font = [UIFont systemFontOfSize:vBodyFontSize];
  textField.backgroundColor = UIColor.clearColor;
  textField.textColor = [UIColor colorNamed:vNTPSpeedDialDomainTextColor];
  ...
  [deleteTextButton setImage:[UIImage
                              systemImageNamed:vBookmarkTextfieldDeleteIcon]
                    forState:UIControlStateNormal];
  [deleteTextButton setImage:[UIImage
                              systemImageNamed:vBookmarkTextfieldDeleteIcon]
                    forState:UIControlStateHighlighted];
  [deleteTextButton setTintColor:[UIColor colorNamed:vNTPToolbarTextColor]];
  ...
  underlineView.backgroundColor =
    [UIColor colorNamed:vBookmarkTextFieldUnderlineColor];

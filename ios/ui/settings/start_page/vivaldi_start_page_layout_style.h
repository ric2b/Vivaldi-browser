...
#ifndef IOS_UI_SETTINGS_VIVALDI_START_PAGE_LAYOUT_STYLE_H_
#define IOS_UI_SETTINGS_VIVALDI_START_PAGE_LAYOUT_STYLE_H_
...
#endif  // IOS_UI_SETTINGS_VIVALDI_START_PAGE_LAYOUT_STYLE_H_
...
#ifndef IOS_NOTES_NOTE_FOLDER_CHOOSER_VIEW_CONTROLLER_H_
#define IOS_NOTES_NOTE_FOLDER_CHOOSER_VIEW_CONTROLLER_H_
...
#endif  // IOS_NOTES_NOTE_FOLDER_CHOOSER_VIEW_CONTROLLER_H_

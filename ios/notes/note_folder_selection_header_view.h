...
#ifndef IOS_NOTES_NOTE_FOLDER_SELECTION_HEADER_VIEW_H_
#define IOS_NOTES_NOTE_FOLDER_SELECTION_HEADER_VIEW_H_
...
#endif  // IOS_NOTES_NOTE_FOLDER_SELECTION_HEADER_VIEW_H_

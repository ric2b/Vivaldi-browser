...
#ifndef IOS_NOTES_CELLS_NOTE_TABLE_CELL_TITLE_EDIT_DELEGATE_H_
#define IOS_NOTES_CELLS_NOTE_TABLE_CELL_TITLE_EDIT_DELEGATE_H_
...
#endif  // IOS_NOTES_CELLS_NOTE_TABLE_CELL_TITLE_EDIT_DELEGATE_H_

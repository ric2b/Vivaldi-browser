...
#ifndef IOS_NOTES_CELLS_NOTE_TABLE_CELL_TITLE_EDITING_H_
#define IOS_NOTES_CELLS_NOTE_TABLE_CELL_TITLE_EDITING_H_
...
#endif  // IOS_NOTES_CELLS_NOTE_TABLE_CELL_TITLE_EDITING_H_

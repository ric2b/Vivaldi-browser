...
#ifndef IOS_NOTES_NOTE_INTERACTION_CONTROLLER_DELEGATE_H_
#define IOS_NOTES_NOTE_INTERACTION_CONTROLLER_DELEGATE_H_
...
#endif  // IOS_NOTES_NOTE_INTERACTION_CONTROLLER_DELEGATE_H_

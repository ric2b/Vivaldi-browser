...
DISABLE(CookieManagerImplTest, GetCookieListAccessTime)
...
DISABLE(ServiceWorkerURLLoaderJobTest, Basic)
DISABLE(ServiceWorkerURLLoaderJobTest, BlobResponse)
DISABLE(ServiceWorkerURLLoaderJobTest, StreamResponseAndCancel)
DISABLE(ServiceWorkerURLLoaderJobTest, Redirect)
DISABLE(ServiceWorkerURLLoaderJobTest, EarlyResponse)
DISABLE(ServiceWorkerURLLoaderJobTest, NonExistentBlobUUIDResponse)
DISABLE(ServiceWorkerURLLoaderJobTest, StreamResponse)
DISABLE(ServiceWorkerURLLoaderJobTest, StreamResponse_Abort)
DISABLE(ServiceWorkerURLLoaderJobTest, NavigationPreload)
DISABLE(ServiceWorkerURLLoaderJobTest, BrokenBlobResponse)

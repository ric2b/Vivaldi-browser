...
RequestFilter::RequestHeaderChanges& RequestFilter::RequestHeaderChanges::
operator=(RequestHeaderChanges&&) = default;
...
RequestFilter::ResponseHeaderChanges& RequestFilter::ResponseHeaderChanges::
operator=(ResponseHeaderChanges&&) = default;
